...
glm::mat4 Renderer2::projectionMatrix(float fov) {
...
void Renderer2::init(std::string vertexShader, std::string fragmentShader) {
...
void Renderer2::setMesh(std::vector<float> vertices, std::vector<float> colours) {
